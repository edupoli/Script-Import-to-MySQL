...
REM verifica se os valores das variaveis count_srv01 e count_srv02 é maior do que 1 caso verdadeiro é executado o bloco de comandos 
...
) ELSE (ECHO Nao existe arquivo para importacao no Servidor srv-outgvprep01)

IF %count_srv02% GTR 1 (
	...
	DEL /Q C:\log_genesys\temp.txt
) ELSE (ECHO Nao existe arquivo para importacao no Servidor srv-outgvprep02)
